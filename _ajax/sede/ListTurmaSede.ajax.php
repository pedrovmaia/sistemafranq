...
switch ($action):
    ...
    case 'list':
        ...
        $Read->FullRead("SELECT projeto.projeto_codigo,
          DATE_FORMAT(projeto.projeto_data_inicio, '%d/%m/%Y') AS projeto_data_inicio,
          DATE_FORMAT(projeto.projeto_data_termino, '%d/%m/%Y') AS projeto_data_termino,
                   ...
                   FROM sys_projetos projeto
                     ...
                     LEFT OUTER JOIN sys_unidades unidades ON unidades.unidade_id = projeto.unidade_id
        ...
        if($Read->getResult()){
            ...
            foreach ($Read->getResult() as $Result){
                ...
                array_push($arr, array(
                        ...
                        "datainicio" => $Result['projeto_data_inicio'],
                        "datafinal" => $Result['projeto_data_termino'],
