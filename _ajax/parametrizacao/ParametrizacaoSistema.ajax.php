...
switch ($action):
    ...
    case 'ParametrizacaoSistemaEditar':
        ...
        if (in_array('', $PostData)):
            ...
            $jSON['redirect'] = "painel.php?exe=parametrizacao/cadastro_parametrizacao_sistema&id=" . $Id;
        endif;

        break;

    case 'ParametrizacaoSistemaAdd':
        ...
        if (in_array('', $PostData)):
            ...
            $jSON['redirect'] = "painel.php?exe=parametrizacao/cadastro_parametrizacao_sistema&id=" . $Create->getResult();
        endif;
