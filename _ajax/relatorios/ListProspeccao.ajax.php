        ...
        if($Read->getResult()){
            ...
            foreach ($Read->getResult() as $Aluno){
                ...
                array_push($arr, array(
                    ...
                    "acoes" => "<span class='td-actions'>" . ($_SESSION['permissao']['ler'] == 1 ? "<a rel='tooltip' href='painel.php?exe=crm/ver_prospeccao&id={$Aluno["pessoa_id"]}' title='Ver' class='btn btn-primary btn-link mr-1'><i class='material-icons'>visibility</i></a>" : '') . " " . "</span>"
                    )
                );
            }
            $manage['rows'] = $arr;
