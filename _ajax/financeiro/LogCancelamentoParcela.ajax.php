...
switch ($action):
	...
	$Read->FullRead("SELECT 
				...
				LEFT OUTER JOIN sys_motivos_cancelamento motivo ON motivo.motivo_cancelamento_id = log.motivo_id
	...
	if($Read->getResult()){
		...
		foreach ($Read->getResult() as $Result){
			...
			array_push($arr, array(
				"id" => $Result['id'],
				"motivo" => $Result['motivo_cancelamento_nome'],
