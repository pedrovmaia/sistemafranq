...
switch ($action):
    ...
    case 'list':
        ...
        $Read->FullRead("SELECT projeto.projeto_id,
                ...
                LEFT OUTER JOIN sys_tipo_projeto tipo_projeto ON tipo_projeto.tipo_projeto_id = projeto.projeto_tipo_id WHERE projeto.unidade_id = :unidade GROUP BY projeto.projeto_id", "unidade={$_SESSION['userSYSFranquia']['unidade_padrao']}");
        if($Read->getResult()){
