...
switch ($action):
    ...
    case 'list':
        ...
        $Read->FullRead("SELECT contrato.contrato_id,
                    ...
                    LEFT OUTER JOIN sys_tipo_contratos tipo ON tipo.tipo_contrato_id = contrato.contrato_tipo_id WHERE contrato.contrato_pessoa_id = :id AND contrato.unidade_id = :unidade", "id={$Id}&unidade={$_SESSION['userSYSFranquia']['unidade_padrao']}");
