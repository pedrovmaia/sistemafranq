                ...
                for($i = 0; $i <= $quantidade_telefone; $i++){
                    if(isset($PostData['tipo_telefone_' . $i])){
                        if (isset($PostData['telid_' . $i])){
                            ...
                            $jSON['redirect'] = "painel.php?exe=pedagogico\consultor\cadastro_consultor&id=" . $Id;
                        } else {
                            $ArrTelefones[] = Array(
                                'pessoa_id' => $Id,
    ...
    case 'ConsultorAdd':
        ...
        elseif (Check::CPF($PostData['pessoa_cpf']) != true):
           ...
           // $Update->ExeUpdate("sys_pessoas", $UpdateData, "WHERE pessoa_id = :id", "id={$PessoaCreateID}");
            ...
            $jSON['redirect'] = "painel.php?exe=pedagogico\consultor\cadastro_consultor&id=" . $PessoaCreateID;
        endif;
