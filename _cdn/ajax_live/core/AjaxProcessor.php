...
header('Access-Control-Allow-Origin: https://localhost/KnnIdiomas/sistema_franquia_svn.git/trunk/');
header('Access-Control-Allow-Methods: *');
header('Content-Type: application/json');

$DS = DIRECTORY_SEPARATOR;
file_exists(__DIR__ . $DS . '_cdn/ajax_live/core'.  $DS . 'Handler.php') ? require_once __DIR__ . $DS . '_cdn/ajax_live/core'.  $DS . 'Handler.php' : die('Handler.php not found');
