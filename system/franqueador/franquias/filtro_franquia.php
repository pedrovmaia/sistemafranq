              ...
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title"><?= $texto['AllFe'] ?></h4>
                          <p class="card-category"><?= $texto['RelFEi'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <div id="toolbar">
                    ...
                    if($permissao["inserir"] == 1) {
                        ?>
                        <a href="<?= BASE ?>/painel.php?exe=franqueador/franquias/cadastro_franquia"
                           class="btn btn-primary pull-right">ADICIONAR NOVA FRANQUIA</a>
                        <?php
                    }
                    ?>
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/franqueador/ListFranquias.ajax.php?action=list"
