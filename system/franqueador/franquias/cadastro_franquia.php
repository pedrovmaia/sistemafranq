...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadFE'] ?></h4>
                                <p class="card-category"><?= $texto['CadFEi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FRANQUEADOR_FRANQUIA."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                            ...
                            <form class="form_franquia">
                                <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?= $Pessoa['pessoa_cnpj'] ?>" name="pessoa_cnpj" class="form-control formCnpj">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Inscrição Municipal</label>
                                ...
                                <br/>
                                <input type="hidden" name="pessoa_tipo_id" value="7"/>
                                <input type="hidden" name="action" value="FranquiaEditar"/>
                                ...
                                if($permissao["deletar"] == 1) {
                                    ?>
                                    <span rel='single_user_addr' callback='franqueador/Franquia' action="delete"
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=franqueador/franquias/cadastro_franquia');
                            exit;
                        endif;
                    else:
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FRANQUEADOR_FRANQUIA."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        <form class="form_franquia">
                            <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Responsavel</label>
                                             <input type="text" name="pessoa_responsavel" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Data do cadastro</label>
                                             ...
                                             <input disabled type="text" name="pessoa_data" value="<?= date('d/m/Y') ?>" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">CNPJ</label>
                                            <input type="text" value="" name="pessoa_cnpj" class="form-control formCnpj">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">HomePage</label>
                                            <input type="text" value="" name="pessoa_homepage" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Inscrição Estadual</label>
                                            <input type="text" value="" name="pessoa_ie" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Inscrição Municipal</label>
                                            <input type="text" value="" name="pessoa_im" class="form-control">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <br/>
                            <input type="hidden" name="action" value="FranquiaAdd"/>
        ...
        <?= $texto['IDFunc'] ?> <?= FRANQUEADOR_FRANQUIA ?>
    </div>
  </div>