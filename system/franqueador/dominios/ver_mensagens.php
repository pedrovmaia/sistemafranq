                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerCBL'] ?></h4>
                                <p class="card-category"><?= $texto['VerCBLi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="mensagem_nome" value="<?= $mensagem_nome ?>" class="form-control">
                        </div>
                    </div>
                           ...
                           <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select disabled class="form-control" name="mensagem_tipo">
...
<div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox" disabled name="mensagem_status" value="1" <?= ($mensagem_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                        </div>
                    </div>
                </div>
                <br/>
        ...
        header('Location: painel.php?exe=franqueador/dominios/cadastro_mensagens');
        exit;
    endif;
endif;
?>
