          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllUN'] ?></h4>
                      <p class="card-category"><?= $texto['RelUNi'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              ...
              if($permissao["ler"] == 1){
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/franqueador/ListUnidades.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="franquia" data-filter-control="input">Franquia</th>
