...
$Delete = new Delete;
$Delete->ExeDelete("sys_tipos_doc_liquidacao", "WHERE tipos_doc_liquidacao_nome IS NULL OR tipos_doc_liquidacao_nome = :nm", "nm=''");
?>
          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllTDL'] ?></h4>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=franqueador/dominios/cadastro_tipos_doc_liquidacao" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/franqueador/ListTiposDocLiquidacao.ajax.php?action=list"
