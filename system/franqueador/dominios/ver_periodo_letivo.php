                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerPLT'] ?></h4>
                                <p class="card-category"><?= $texto['VerPLTi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="periodo_letivo_descricao" value="<?= $periodo_letivo_descricao ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox" disabled name="periodo_letivo_status" value="1" <?= ($periodo_letivo_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                        </div>
                    </div>
                </div>
                <br/>
