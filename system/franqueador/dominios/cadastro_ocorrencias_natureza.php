                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title">CADASTRO DE OCORRÊNCIAS - NATUREZA</h4>
                                <p class="card-category">Cadastro de ocorrências - natureza</p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                            ...
                            if ($Read->getResult()):
                                ...
                                <form class="form_ocorrencias_tipo_acao">
                                    ...
                                    if($permissao["deletar"] == 1) {
                                        ?>
                                        <span rel='single_user_addr' callback='franqueador/OcorrenciasNatureza' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                                        <?php
                                    }
                                    ?>
