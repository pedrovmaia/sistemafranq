...
if ($Id):
    ...
    if ($Read->getResult()):
                                      ...
                                      <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="checkbox" disabled name="avaliacao_status" value="1" <?= ($avaliacao_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
        ...
        header('Location: painel.php?exe=franqueador/dominios/cadastro_avaliacoes');
        exit;
    endif;
endif;
?>
