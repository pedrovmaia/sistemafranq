                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerUN'] ?></h4>
                                <p class="card-category"><?= $texto['VerUNi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="unidade_nome" value="<?= $unidade_nome ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                              <label class="bmd-label-floating">FRANQUIA</label>
                                            <select disabled value="<?= $FormData['franquia_id'] ?>" name="franquia_id" class="form-control" data-style="btn btn-link">
                                                <?php
                                                $Read->ExeRead("sys_pessoas");
                                                if ($Read->getResult()):
                                                    foreach ($Read->getResult() as $Pessoa):
                                                        ?>
                                                         <option value="<?= $Pessoa['pessoa_id'] ?>" <?php if ($FormData['franquia_id']  == $Pessoa['pessoa_id'] ) { echo "selected";}  ?>  ><?php echo $Pessoa['pessoa_nome']; ?></option>
                                                    <?php
                                                    endforeach;
                                                endif;
                                                ?>
