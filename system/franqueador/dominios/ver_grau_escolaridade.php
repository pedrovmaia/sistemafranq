                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerGES'] ?></h4>
                                <p class="card-category"><?= $texto['VerGESi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="grau_escolaridade_nome" value="<?= $grau_escolaridade_nome ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox" disabled name="grau_escolaridade_status" value="1" <?= ($grau_escolaridade_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                        </div>
                    </div>
                </div>
                <br/>
