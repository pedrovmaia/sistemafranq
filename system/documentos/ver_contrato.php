                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerCONTRAC'] ?></h4>
                                       ...
                                       <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                          <div class="form-group" >
                                                ...
                                                <input disabled type="text" name="contrato_data_vencimento"value="<?= date('d/m/Y', strtotime($contrato_data_vencimento)) ?>" class="form-control">
