...
$Delete = new Delete;
$Delete->ExeDelete("sys_contratos", "WHERE contrato_nome IS NULL OR contrato_nome = :nm", "nm=''");
?>
          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllCONTRAC'] ?></h4>
                      <p class="card-category"><?= $texto['RelCONTRAC'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=documentos/cadastro_contrato" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/documentos/ListContrato.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true"data-filter-control-placeholder="⌕" data-sortable="true" data-field="matricula" data-filter-control="input"><?= $texto['Mat'] ?></th>
