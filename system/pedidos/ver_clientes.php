            ...
            <div class="col-md-12">
                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerCLNTTSS'] ?></h4>
                                <p class="card-category"><?= $texto['VerCLNTTSSi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="btn-group">
                   ...
                   <div class="btn-group">
                    ...
                    <li><a href="<?= BASE ?>/painel.php?exe=rh/filtro_teste_pessoa&id=<?= $Pessoa["pessoa_id"] ?>"><?= $texto['CONTRATC'] ?></a></li>
                   ...
                   <div class="btn-group">
                    ...
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown"><?= $texto['MoreINFO'] ?><span class="caret"></span></button>

                    <ul class="dropdown-menu" role="menu">

                    <li><a href="<?= BASE ?>/painel.php?exe=rh/filtro_teste_pessoa&id=<?= $Pessoa["pessoa_id"] ?>"><?= $texto['EXMPL'] ?></a></li>
