              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=pedidos/proposta/cadastro_proposta" class="btn btn-primary pull-right">ADICIONAR NOVA PROPOSTA</a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/pedido/ListProposta.ajax.php?action=list"
