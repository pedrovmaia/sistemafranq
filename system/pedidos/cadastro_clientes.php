                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadCLNTTSS'] ?></h4>
                                <p class="card-category"><?= $texto['CadCLNTTSSi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        ...
                        ?>
                            <form class="form_clientes">
                                ...
                                <input type="hidden" name="action" value="ClientesEditar"/>
                        ...
                        <form class="form_clientes">
                            ...
                            <br/>
                            <input type="hidden" name="action" value="ClientesAdd"/>
