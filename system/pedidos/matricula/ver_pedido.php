    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerMATRC'] ?></h4>
                                <p class="card-category"><?= $texto['VerMATRCi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
            ...
            if ($Id):
                ...
                $Read->ExeRead("sys_matriculas", "WHERE matricula_id = :id", "id={$Id}");
                if ($Read->getResult()):
                    $FormData = array_map('htmlspecialchars', $Read->getResult()[0]);
                    extract($FormData);
                    $Read->FullRead("SELECT pessoa_nome FROM sys_pessoas WHERE pessoa_id = :id", "id={$matricula_cliente_id}");
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled value="<?= $PessoaNome ?>" type="text" placeholder="Clique e selecione o cliente / aluno" name="pessoa_nome" class="form-control">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating"><?= $texto['PriceM'] ?></label>
                                                            <input disabled autocomplete="off" value="<?= number_format($matricula_valor_total, 2, ',', '.') ?>" type="text" name="pedido_valor_total" class="form-control dinheiro">
                                                        </div>
                                                    </div>
                                                            ...
                                                            <select disabled style="margin-top: -3px" class="form-control" name="matricula_patrocinador_id">
                                                                ...
                                                                if ($Read->getResult()):
                                                                    foreach ($Read->getResult() as $Patrocinador):
                                                                        ?>
                                                                        <option <?= ($matricula_patrocinador_id == $Patrocinador['patrocionador_id'] ? "selected='selected'" : ""); ?> value="<?= $Patrocinador['patrocionador_id'] ?>"><?= $Patrocinador['patrocionador_nome'] ?></option>
                                                                    <?php
                                                                    endforeach;
                                                                endif;
                                                                ?>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label class="bmd-label-floating">Valor com descontos</label>
                                                            <?php
                                                            $Read->FullRead("SELECT SUM(I.matricula_item_valor_total) AS total FROM sys_matricula_item AS I WHERE I.matricula_item_proposta_id = :id", "id={$matricula_id}");
                                                            ?>
                                                            <input disabled autocomplete="off" value="<?= number_format($Read->getResult()[0]['total'], 2, ',', '.') ?>" type="text" name="pedido_valor_total" class="form-control dinheiro">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input disabled value="<?= $matricula_observacao ?>" autocomplete="off" type="text" name="pedido_observacao" class="form-control">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body table-responsive">
                                                                <table class="table table-hover j_tabela_matricula_estagios_curso">
                                                                    ...
                                                                    <?php
                                                                    $i = 0;
                                                                    $Read->FullRead("SELECT P.estagio_produto_nome, I.* FROM sys_estagio_produto AS P INNER JOIN sys_matricula_item AS I ON P.estagio_produto_id = I.matricula_item_produto_id WHERE I.matricula_item_proposta_id = :id AND I.matricula_item_tipo = 1", "id={$matricula_id}");
                                                                    if($Read->getResult()) {
                                                                        foreach ($Read->getResult() as $Produtos) {
                                                                            ...
                                                                            <tr class="table_<?= $i ?>">
                                                                                <td>
                                                                                    ...
                                                                                    <input value="<?= $Produtos['matricula_item_produto_id'] ?>" type="hidden" name="nome_produto_<?= $i ?>_id">
                                                                                </td>
                                                                                ...
                                                                                <td>
                                                                                    <input disabled="" autocomplete="off" min="0" type="text" name="proposta_item_valor_total_<?= $i ?>" class="form-control proposta_item_valor_total_<?= $i ?> valor_total_tabela formMoney" value="<?= $Produtos['matricula_item_valor_total'] ?>">
                                                                                    <input type="hidden" name="proposta_item_valor_original_<?= $i ?>" class="proposta_item_valor_original_<?= $i ?>" value="<?= $Produtos['matricula_item_valor_total_sem_desconto'] ?>">
                                                                                    <input disabled="" type="hidden" name="proposta_item_valor_unitario_<?= $i ?>" class="form-control proposta_item_valor_unitario_<?= $i ?> dinheiro" value="<?= number_format($Produtos['matricula_item_valor_unitario'], 2, ',', '.') ?>">
                                                                                    <input type="hidden" name="proposta_item_quantidade_<?= $i ?>" class="form-control proposta_item_quantidade_<?= $i ?>" value="<?= $Produtos['matricula_item_quantidade'] ?>">
                                                                                    <input type="hidden" class="desconto_matricula_<?= $i ?>" name="desconto_matricula_<?= $i ?>" value="<?= $Produtos['matricula_desconto_id'] ?>">
                                                                                    <input type="hidden" class="proposta_item_parcelamento_id_<?= $i ?>" name="proposta_item_parcelamento_id_<?= $i ?>" value="<?= $Produtos['matricula_item_forma_parcelamento_id'] ?>">
                                                                                    <input type="hidden" value="<?= $Produtos['matricula_item_entrada'] ?>" name="proposta_entrada_<?= $i ?>" class="proposta_valor_entrada proposta_entrada_<?= $i ?>">
                                                                                    <input type="hidden" value="<?= $Produtos['matricula_data_entrada'] ?>" name="proposta_data_entrada_<?= $i ?>" class="proposta_data_entrada_<?= $i ?>">
                                                                                    <input type="hidden" value="<?= $Produtos['matricula_dia_vencimento_id'] ?>" name="proposta_dia_vencimento_<?= $i ?>" class="proposta_dia_vencimento_<?= $i ?>">
                                                                                    <input type="hidden" value="<?= date('Y-m-d', strtotime($Produtos['matricula_data_primeiro_vencimento'])) ?>" name="proposta_data_primeiro_vencimento_<?= $i ?>" class="proposta_data_primeiro_vencimento_<?= $i ?>"
                                                                                </td>
                                                                                <td class="text-right">
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card-body table-responsive">
                                                                <table class="table table-hover j_tabela_matricula_materia_didaticos_curso">
                                                                    ...
                                                                    <tbody>
                                                                    <?php
                                                                    $Read->FullRead("SELECT P.produto_nome, I.* FROM sys_produto AS P INNER JOIN sys_matricula_item AS I ON P.produto_id = I.matricula_item_produto_id WHERE I.matricula_item_proposta_id = :id AND I.matricula_item_tipo = 2", "id={$matricula_id}");
                                                                    if ($Read->getResult()) {
                                                                        foreach ($Read->getResult() as $Produtos) {
                                                                            ?>
                                                                            <tr class="table_<?= $i ?>">
                                                ...
                                                <div class="row">
                                                    <div class="table-responsive" style="padding: 10px">
                                                        <table class="table table-bordered table-responsive-md table-striped text-center table_centro_custo">
                                                            ...
                                                            <?php
                                                            $Read->FullRead("SELECT C.centro_custo_nome, CC.conta_contabil_nome, R.pedido_rateio_valor FROM sys_centro_custo AS C INNER JOIN sys_pedido_rateio AS R ON C.centro_custo_id = R.pedido_rateio_centro_custo_id INNER JOIN sys_conta_contabil AS CC ON R.pedido_rateio_conta_contabil_id = CC.conta_contabil_id INNER JOIN sys_movimentacao AS m ON m.movimentacao_id = R.pedido_rateio_proposta_id WHERE m.movimentacao_matricula_id = :id", "id={$matricula_id}");
                                                            if($Read->getResult()) {
                                                                foreach ($Read->getResult() as $Custo) {
                                                                    ?>
                                                                    <tr>
                                                                        <td class="pt-4-half">
                                                                            <input disabled value="<?= $Custo['centro_custo_nome'] ?>" type="text" class="form-control">
                                                                        </td>
                                                                        <td class="pt-4-half">
                                                                            <input disabled value="<?= $Custo['conta_contabil_nome'] ?>" type="text" class="form-control">
                                                                        </td>
                                                                        <td class="pt-4-half">
                                                                            <input disabled value="<?= number_format($Custo['pedido_rateio_valor'], 2, ',', '.') ?>" type="text" class="form-control">
                                                                        </td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                        ...
                                        <div class="tab-pane" id="messages">
                                            <div class="border_shadow" style="padding: 20px">
                                                <table  class="table table-hover display"
                                                        ...
                                                        data-url="_ajax/financeiro/ListParcelasPorMatricula.ajax.php?action=list&pedido_id=<?= $Id ?>"
                    ...
                    //header('Location: painel.php?exe=pedidos/matricula/cadastro_pedido');
                    exit;
                endif;
            endif;
            ?>
