          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllPDS'] ?></h4>
                      <p class="card-category"><?= $texto['RelPDS'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              ...
              if($permissao["ler"] == 1){
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                           ...
                           <?php if(isset($_SESSION['caixaSYS']))
                                    {?> 
                          <a href="<?= BASE ?>/painel.php?exe=pedidos/pedido/cadastro_pedido" class="btn btn-primary pull-right"><?= $texto['ADDPDS'] ?></a>
                          <?php
                          }
                          ?>
                          <?php
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/pedido/ListPedido.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" class="nome" data-field="nome" data-filter-control="input"><?= $texto['CLNT'] ?></th>
