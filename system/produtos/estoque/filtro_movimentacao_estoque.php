          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllMOVESTQ'] ?></h4>
                      <p class="card-category"><?= $texto['RelMOVESTQ'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=produtos/estoque/cadastro_movimentacao_estoque" class="btn btn-primary pull-right"><?= $texto['ADDMOV'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/produto/ListMovimentacaoEstoque.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="quantidade" data-filter-control="input"><?= $texto['QNTi'] ?></th>
