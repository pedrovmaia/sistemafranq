                                ...
                                <form class="form_exercicio2">
                                    <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                                        ...
                                        <div class="row">
                                              ...
                                              <div class="col-md-6">
                                                     <div class="form-group">
                                                     <label  class="bmd-label-floating"><?= $texto['EstCRSOi'] ?></label>
                                                   
                                                     <select style="margin-top: -3px" name="exercicio_estagio_id" class="form-control" data-style="btn btn-link">

                                                         <option value=""><?= $texto['SelEstCRSOi'] ?></option>
                                                        ...
                                                        if ($Read->getResult()):
                                                            foreach ($Read->getResult() as $Estagio):
                                                                ?>
                                                                <option <?= ($exercicio_estagio_id == $Estagio['estagio_produto_id'] ? "selected='selected'" : "") ?> value="<?= $Estagio['estagio_produto_id'] ?>"><?= $Estagio['estagio_produto_nome'] ?></option>
                                                            <?php
                                                            endforeach;
                                                        endif;
                                                        ?>
                ...
                <div class="col-md-6">
                                ...
                                <div class="row">
                                    ...
                                    if($permissao["deletar"] == 1) {
                                        ?>
                                        <span rel='single_user_addr' callback='escola/Exercicio2' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group">
                                                     <label  class="bmd-label-floating"><?= $texto['EstCRSOi'] ?></label>
                                                     <select style="margin-top: -3px" name="exercicio_estagio_id" class="form-control">
                                                        <option value=""><?= $texto['SelEstCRSOi'] ?></option>
                                                        <?php
                                                        $Read->ExeRead("sys_estagio_produto", "WHERE estagio_produto_status = :st", "st=0");
                                                        if ($Read->getResult()):
