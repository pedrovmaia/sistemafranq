...
if($Id && $IdCurso){
    ...
    //ESTÁGIO
    $Read->ExeRead("sys_estagio_produto", "WHERE estagio_produto_produto_id = :id", "id={$IdCurso}");
    if($Read->getResult()){
          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todas as etapas de <?= $Curso['produto_nome'] . " - " . $Estagio['estagio_produto_nome'] ?></h4>
                      <p class="card-category">Relação de etapas</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=escola/admin/cadastro_etapa_avaliacao&id=<?= $Id ?>&idcurso=<?= $IdCurso ?>" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/escola/ListEtapaAvaliacao.ajax.php?action=list&id=<?= $Id ?>"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true"data-filter-control-placeholder="⌕" data-sortable="true" data-field="inicial" data-filter-control="input">Matéria Inicial</th>
                          <th data-filter-control-placeholder="⌕" data-sortable="true"data-filter-control-placeholder="⌕" data-sortable="true" data-field="final" data-filter-control="input">Matéria Final</th>
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="curso" data-filter-control="input">Curso</th>
                          <th data-filter-control-placeholder="⌕" data-sortable="true"data-filter-control-placeholder="⌕" data-sortable="true" data-field="estagio" data-filter-control="input">Estágio</th>
