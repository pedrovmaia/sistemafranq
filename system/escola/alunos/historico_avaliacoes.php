                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title">VER AVALIAÇÕES</h4>
                                <p class="card-category">Exibição de Avaliações Do Aluno</p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        if ($Id):
                            ...
                            $Read->FullRead("SELECT * FROM sys_acompanhamento_aula_avaliacoes AS a WHERE a.pessoa_id = :id", "id={$Id}");
                            if ($Read->getResult()):
                                            ...
                                            <div class="card-body">
                                                <div class="tab-content">
                                                    <div class="tab-pane active" id="profile">
                                                        ...
                                                        <?= $Total_Avaliacoes_Realizadas ?> avaliações realizadas
