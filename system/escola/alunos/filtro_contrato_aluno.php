          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todos os contratos</h4>
                      <p class="card-category">Relação de contratos</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              ...
              if($permissao["ler"] == 1){
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/escola/ListContratoAluno.ajax.php?action=list&id=<?= $Id ?>"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="matricula" data-filter-control="input">Matrícula</th>
