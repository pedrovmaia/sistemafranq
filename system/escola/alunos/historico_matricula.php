  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Historico de Matrículas</h4>
            ...
            <div class="card-body">
                ...
                <?php
                  $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".ESCOLA_HISTORICO_MATRICULA."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                  if($Read->getResult()){
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/escola/ListHistoricoMatricula.ajax.php?action=list&id=<?= $Id ?>"
                    ...
                    <tr>
                        ...
                        <th data-filter-control-placeholder="⌕" data-sortable="true"data-filter-control-placeholder="⌕" data-sortable="true" data-field="status" data-filter-control="input">Status</th>
        ...
        ID FUNCIONALIDADE: <?= ESCOLA_HISTORICO_MATRICULA ?>
    </div>
     <?php
    } else {
  die("Erro");
