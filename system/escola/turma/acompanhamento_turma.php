                ...
                if($permissao["ler"] != 1){
                    ...
                    ?>
                        <div class="border_shadow" style="padding: 20px">
                            <div class="card">
                              <div class="card-header" style="padding-bottom: 0">
                                  <h3><strong>Lista de Presença</strong></h3>
                              </div>
                              <div class="card-body" style="padding-top: 0">
                                  <table  class="table table-hover display"
                                          ...
                                          data-url="_ajax/escola/ListPlanejamento.ajax.php?action=listacompanamento&planejamento_id=<?= $Id; ?>"
                                      ...
                                      <tr>
                                          ...
                                          <th data-field="presenca" data-filter-control="input">Presença</th>
                        ...
                        <div class="border_shadow" style="padding: 20px">
                            <div class="card">
                                <div class="card-header" style="padding-bottom: 0">
                                    <h3><strong>Matérias Realizadas</strong></h3>
                                </div>
                                <div class="card-body" style="padding-top: 0">
                                    <table  class="table table-hover display"
                                            id="table2"
                                            ...
                                            data-show-columns="true"
                                            data-minimum-count-columns="2"
                                            data-url="_ajax/escola/ListPlanejamento.ajax.php?action=listamaterias&planejamento_id=<?= $Id; ?>"
                                            data-pagination="true"
                                            data-id-field="id"
                                            data-page-size="30"
                                            data-buttons-class="primary">
                        ...
                        <div class="border_shadow" style="padding: 20px">
                            <div class="card">
                                <div class="card-header" style="padding-bottom: 0">
                                    <h3><strong>Avaliações Realizadas</strong></h3>
                                </div>
                                <div class="card-body" style="padding-top: 0">
                                    <table  class="table table-hover display"
                                            id="table3"
                                            ...
                                            data-show-columns="true"
                                            data-minimum-count-columns="2"
                                            data-url="_ajax/escola/ListPlanejamento.ajax.php?action=listaavaliacoes&planejamento_id=<?= $Id; ?>"
                                            data-pagination="true"
                                            data-id-field="id"
                                            data-page-size="30"
                                            data-buttons-class="primary">
                        ...
                        <div class="border_shadow" style="padding: 20px">
                            <div class="card">
                                <div class="card-header" style="padding-bottom: 0">
                                    <h3><strong>Home Works Realizadas</strong></h3>
                                </div>
                                <div class="card-body" style="padding-top: 0">
                                    <table  class="table table-hover display"
                                            id="table4"
                                            ...
                                            data-show-columns="true"
                                            data-minimum-count-columns="2"
                                            data-url="_ajax/escola/ListPlanejamento.ajax.php?action=listahomework&planejamento_id=<?= $Id; ?>"
                                            data-pagination="true"
                                            data-id-field="id"
                                            data-page-size="30"
                                            data-buttons-class="primary">
                        ...
                        <div class="border_shadow" style="padding: 20px">
                            <div class="card">
                                <div class="card-header" style="padding-bottom: 0">
                                    <h3><strong>Exercícios Realizados</strong></h3>
                                </div>
                                <div class="card-body" style="padding-top: 0">
                                    <table  class="table table-hover display"
                                            id="table5"
                                            ...
                                            data-show-columns="true"
                                            data-minimum-count-columns="2"
                                            data-url="_ajax/escola/ListPlanejamento.ajax.php?action=listaexercicios&planejamento_id=<?= $Id; ?>"
                                            data-pagination="true"
                                            data-id-field="id"
                                            data-page-size="30"
                                            data-buttons-class="primary">
