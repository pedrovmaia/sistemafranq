                            ...
                            if ($Read->getResult()):
                                ...
                                <form class="form_homework2">
                                    ...
                                    if($permissao["deletar"] == 1) {
                                        ?>
                                        <span rel='single_user_addr' callback='escola/Homework2' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                                        <?php
                                    }
                                    ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                 <div class="form-group">
                                                     <label  class="bmd-label-floating"><?= $texto['EstCRSOi'] ?></label>
                                                     <select style="margin-top: -3px" name="homework_estagio_id" class="form-control">
                                                        <option value=""><?= $texto['SelEstCRSOi'] ?></option>
                                                        <?php
                                                        $Read->ExeRead("sys_estagio_produto", "WHERE estagio_produto_status = :st", "st=0");
                                                        if ($Read->getResult()):
