                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadFORN'] ?></h4>
                                <p class="card-category"><?= $texto['CadFORNi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        ...
                        ?>
                            <form class="form_fornecedor">
                                ...
                                <input type="hidden" name="action" value="FornecedorEditar"/>
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=fornecedores/fornecedor/cadastro_fornecedor');
                            exit;
                        endif;
                    else:
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FORNECEDORES_FORNECEDOR."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        <form class="form_fornecedor">
                            ...
                            <br/>
                            <input type="hidden" name="action" value="FornecedorAdd"/>
