                ...
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerPRESTSERVC'] ?></h4>
                                <p class="card-category"><?= $texto['VerPRESTSERVCi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=rh/colaborador/cadastro_prestador');
                            exit;
                        endif;
                    endif;
                    ?>
