              ...
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title"><?= $texto['AllPRESTSERVC'] ?></h4>
                          <p class="card-category"><?= $texto['RelPRESTSERVC'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <div id="toolbar">
                    ...
                    if($permissao["inserir"] == 1) {
                        ?>
                        <a href="<?= BASE ?>/painel.php?exe=fornecedores/prestador/cadastro_prestador"
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/fornecedores/ListPrestador.ajax.php?action=list"
