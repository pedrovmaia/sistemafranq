...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadPRESTSERVC'] ?></h4>
                                <p class="card-category"><?= $texto['CadPRESTSERVCi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FORNECEDORES_PRESTADOR."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        ?>
                            <form class="form_prestador">
                                ...
                                <br/>
                                <input type="hidden" name="pessoa_tipo_id" value="3"/>
                                <input type="hidden" name="action" value="PrestadorEditar"/>
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=fornecedores/prestador/cadastro_prestador');
                            exit;
                        endif;
                    else:
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FORNECEDORES_PRESTADOR."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        <form class="form_prestador">
                            ...
                            <br/>
                            <input type="hidden" name="action" value="PrestadorAdd"/>
        ...
        ID FUNCIONALIDADE: <?= FORNECEDORES_PRESTADOR ?>
    </div>
  </div>