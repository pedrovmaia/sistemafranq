        ...
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title"><?= $texto['AllCOLABES'] ?></h4>
                          <p class="card-category"><?= $texto['RelCOLABES'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <table class="table table-hover display table-sm table_list_none"
                        id="table-colaborador"
                        ...
                        data-url="_ajax/rh/ListColaborador.ajax.php?action=list"
