...
<div class="content">
  <div class="container-fluid">
            ...
            <div class="card-header card-header-primary">
                <div class="row">
                    ...
                    <div class="col-md-10 text-center">
                        <h4 class="card-title">RELAÇÃO GERENTE/CONSULTOR</h4>
                        <p class="card-category">Cadastro de relação dos gerentes com consultores</p>
                    </div>
                    <div class="col-md-1">
                    </div>
                </div>
              ...
              <form class="form-cadastro-relacao-gerente-campo-consultor-campo">
                  <div class="form-group">
                      ...
                      <select name="pessoa_principal_id" class="form-control jsys_gerente_consultor" data-style="btn btn-link">
                          <option value="0">Selecione um Gerente de Campo</option>
                          <?php
                  ...
                  <div class="form-group">
                      <label for="exampleFormControlSelect2">Consultores de Campo</label>
                      <div class="dropdown bootstrap-select show-tick form-control dropup">
                          <select name="consultores[]" multiple="" class="form-control selectpicker" data-style="btn btn-link" id="select_consultores">
                              <option value="0" disabled="">Selecione os consultores de campo</option>
                              <?php
    ...
    ID FUNCIONALIDADE: <?= ESCOLA_RELACAO_GERENTE_CONSULTOR ?>
  </div>
</div>
