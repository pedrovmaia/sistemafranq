                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required name="pessoa_acesso_id" class="form-control" data-style="btn btn-link">
                                                    <option value=""><?= $texto['SelNVLAC'] ?></option>
                                                    <?php
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select required class="form-control" name="pessoa_cargo_id">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Senha acesso</label>
                                                <input type="password" value="" name="acesso_senha" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['NOMEC'] ?></label>
                                            <input required type="text" value="" name="pessoa_nome" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['GENE'] ?></label>
                                            <select required class="form-control" name="pessoa_sexo">
                                                <option selected disabled value=""><?= $texto['SelGENE'] ?></option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['DTNASC'] ?></label>
                                            <input required type="text" value="" name="pessoa_nascimento" class="form-control formDate">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['CPF'] ?></label>
                                            <input required type="text" value="" name="pessoa_cpf" class="form-control formCpf">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Email</label>
                                            <input required type="text" value="" name="pessoa_email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['PROFSSA'] ?></label>
                                            <input required type="text" value="" name="pessoa_profissao" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">RG</label>
                                            <input required type="text" value="" name="pessoa_rg" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['OrgEM'] ?></label>
                                            <input required type="text" value="" name="pessoa_emissor" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['TPCOLAB'] ?></label>
                                            <select required class="form-control" name="pessoa_tipo_id">
                                                <option selected disabled value=""><?= $texto['SelTPCOLAB'] ?></option>
                                                <?php
                                                $Read = new Read;
                                                $Read->ExeRead("sys_tipo_pessoas");
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required class="form-control" name="pessoa_cargo_id">
                                                ...
                                                if($Read->getResult()):
                                                    foreach ($Read->getResult() as $Unidades):
                                                        echo "<option value='{$Unidades['cargo_id'] }'>{$Unidades['cargo_descricao'] }</option>";
                                                    endforeach;
                                                endif;
                                                ?>
                                            </select>
                            ...
                            <div id="endereco_consumidor" class="border_shadow" style="padding: 15px;">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">CEP</label>
                                            <input type="text" required value="" name="catalogo_cep" class="form-control formCep getCep">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['ENDEREC'] ?></label>
                                            <input type="text" required value="" name="catalogo_endereco" class="form-control sys_logradouro">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">Nº</label>
                                            <input type="text" required value="" name="catalogo_numero" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['BAIR'] ?></label>
                                            <input type="text" required value="" name="catalogo_bairro" class="form-control sys_bairro">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['CDDE'] ?></label>
                                            <input type="text" required value="" name="catalogo_cidade" class="form-control sys_localidade">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating">UF</label>
                                            <input type="text" required value="" name="catalogo_uf" class="form-control sys_uf">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['PAISS'] ?></label>
                                            <input type="text" required value="" name="catalogo_pais" class="form-control">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                            ...
                            <div id="endereco_consumidor" class="border_shadow" style="padding: 15px;">
                                ...
                                <div class="row">
                                    ...
                                    <table class="table table-bordered table-responsive-md table-striped text-center table_telefone">
                                        ...
                                        <tr>
                                            <td class="pt-3-half">
                                                <select required name='tipo_telefone_0' class="form-control">
