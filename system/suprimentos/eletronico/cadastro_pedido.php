                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadPDSELE'] ?></h4>
                                <p class="card-category"><?= $texto['CadPDSELEi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <a>
                                                    <input readonly type="text" placeholder="Clique e selecione seu fornecedor" value="KNN FRANCHISING" name="nome_fornecedor" id="nome_fornecedor" class="form-control">
                                                </a>
                                                <input id="txt_id_fornecedor" type="hidden" value="89" name="txt_id_fornecedor" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
