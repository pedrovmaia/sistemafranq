          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllPDSELE'] ?></h4>
                      <p class="card-category"><?= $texto['RelPDSELE'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=suprimentos/eletronico/cadastro_pedido" class="btn btn-primary pull-right"><?= $texto['ADDPDS'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/suprimentos/ListPedidoEletronico.ajax.php?action=list"
