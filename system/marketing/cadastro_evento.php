                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title">CADASTRO DE EVENTOS</h4>
                                <p class="card-category">Cadastro de eventos</p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
...
if ($Id):
    ...
    if ($Read->getResult()):
        ...
        <form class="form_evento">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="evento_descricao" value="<?= $evento_descricao ?>" class="form-control">
                        </div>
                    </div> 
                     ...
                     <div class="col-md-6">
                                                     ...
                                                     <select style="margin-top: -3px" name="evento_tipo_id" value="<?= $evento_tipo_id ?>" class="form-control" data-style="btn btn-link">
            ...
            <br/>
            <input type="hidden" name="action" value="EventoEditar"/>
            ...
            if($permissao["deletar"] == 1) {
                ?>
                <span rel='single_user_addr' callback='marketing/Evento' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                <?php
            }
            ?>
        ...
        <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
           <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="bmd-label-floating">DESCRIÇÃO</label>
                            <input type="text" name="evento_descricao" class="form-control">
                        </div>
                    </div> 
                     ...
                     <div class="col-md-6">
                                                     <div class="form-group">
                                                     <label  class="bmd-label-floating">TIPO</label>
                                                     <select style="margin-top: -3px" name="evento_tipo_id" class="form-control" data-style="btn btn-link">
                                                        ...
                                                        if ($Read->getResult()):
                                                            foreach ($Read->getResult() as $Tipo):
                                                                ?>
                                                                 <option value="<?= $Tipo['tipo_evento_id'] ?>"><?= $Tipo['tipo_evento_nome'] ?></option>
                                                            <?php
                                                            endforeach;
                                                        endif;
                                                        ?>
