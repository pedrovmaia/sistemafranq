                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['NewMovPG'] ?></h4>
                                <p class="card-category"><?= $texto['InclusePG'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    <div class="card-body">
                      ...
                      if ($Id):
                          ...
                          if ($Read->getResult()):
                              ...
                              extract($FormData);
                              ?>
                              <form class="form_movimentacao_pagamento" autocomplete="false">
                                  ...
                                  if($permissao["deletar"] == 1) {
                                      ?>
                                      <span rel='single_user_addr' callback='financeiro/MovimentacaoPagamento' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                                      <?php
                                  }
                                  ?>
                        ...
                        <form class="form_movimentacao_pagamento">
                            <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['NumberTitles'] ?></label>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['DateTitles'] ?></label>
                                            <input  type="date" value="<?= date('Y-m-d') ?>" name="movimentacao_data" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <a data-toggle="modal" data-target="#getCodeModalFornecedor">
                                                <input readonly placeholder="Clique e selecione seu fornecedor" id="nome_fornecedor" type="text" name="movimentacao_pessoa_nome"  class="form-control">
                                            </a>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['TipeTitles'] ?></label>
                                ...
                                <div class="row">
                                 ...
                                 <div class="row">
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['PAG'] ?></label>
                                    ...
                                    <div class="col-md-3" id="hidden_div_data" style="display: none" >
                                        <div class="form-group">
                                            ...
                                            <input autocomplete="off"  type="date" name="movimentacao_data_fechamento" class="form-control dinheiro">
                                        </div>
                                    </div>
                            ...
                            <input type="hidden" name="movimentacao_tipo_id" value="1"/>
                            <input type="hidden" name="movimentacao_nome" value="Movimentação de pagamento"/>
