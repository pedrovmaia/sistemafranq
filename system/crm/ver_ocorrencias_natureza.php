                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerOCRRNAT'] ?></h4>
                                <p class="card-category"><?= $texto['VerOCRRNATi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select disabled value="<?= $FormData['responsavel_id'] ?>" name="responsavel_id" class="form-control" data-style="btn btn-link">
                                                <?php
                                                $Read->ExeRead("sys_pessoas");
                                                if ($Read->getResult()):
                                                    foreach ($Read->getResult() as $Pessoa):
                                                        ?>
                                                         <option value="<?= $Pessoa['pessoa_id'] ?>" <?php if ($FormData['responsavel_id']  == $Pessoa['pessoa_id'] ) { echo "selected";}  ?>  ><?php echo $Pessoa['pessoa_nome']; ?></option>
                                                    <?php
                                                    endforeach;
                                                endif;
                                                ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="ocorrencias_natureza_nome" value="<?= $ocorrencias_natureza_nome ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox" disabled name="ocorrencias_natureza_status" value="1" <?= ($ocorrencias_natureza_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                        </div>
                    </div>
                </div>
                <br/>
