              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=crm/cadastro_ocorrencia&idpessoa=<?= $Id ?>" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/Crm/ListOcorrencia.ajax.php?action=list&id=<?= $Id ?>"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="natureza" data-filter-control="input"><?= $texto['Nati'] ?></th>
                          ...
                          <th class="acoes headcol" data-field="acoes"><span style="margin-left: 30px";> <?= $texto['Act'] ?></th>
                      </tr>
                      </thead>
                  </table>
                </div>
