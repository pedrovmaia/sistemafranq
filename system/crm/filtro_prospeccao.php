          ...
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title"><?= $texto['AllPROSPECT'] ?></h4>
                          <p class="card-category"><?= $texto['AllPROSPECTCD'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/Crm/ListProspeccao.ajax.php?action=list"
                    ...
                    <tr>
                        ...
                        <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="telefone" data-filter-control="input">Telefone</th>
