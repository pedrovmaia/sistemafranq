        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadPEOPSS'] ?></h4>
                                <p class="card-category"><?= $texto['CadPEOPSSi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".CRM_PESSOAS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        ?>
                            <form class="form_pessoas">
                                ...
                                <br/>
                                <input type="hidden" name="action" value="PessoasEditar"/>
                                ...
                                if($permissao["deletar"] == 1) {
                                    ?>
                                    <span rel='single_user_addr' callback='Crm/Pessoas' action="delete"
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=crm/cadastro_pessoas');
                            exit;
                        endif;
                    else:
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".CRM_PESSOAS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        <form class="form_pessoas">
                            ...
                            <br/>
                            <input type="hidden" name="action" value="PessoasAdd"/>
                            <input type="hidden" class="quantidade_telefone" name="quantidade_telefone" value="1"/>
                            <input type="hidden" name="pessoa_tipo_id" value="5"/>
                            <button type="submit" class="btn btn-primary"><?= $texto['sav'] ?></button>
                            <img class="form_load" src="<?= BASE ?>/assets/img/load.gif" alt="[CARREGANDO...]"
                                 title="CARREGANDO..."/>
                            <div class="clearfix"></div>
