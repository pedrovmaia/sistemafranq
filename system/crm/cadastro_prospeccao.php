...
<div class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['CadPROSPECT'] ?></h4>
                                <p class="card-category"><?= $texto['CadPROSPECTSH'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                    ...
                    if ($Id):
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".CRM_PROSPECCAO."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        ?>
                            <form class="form_prospeccao">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" value="<?= $Pessoa['pessoa_nome'] ?>" name="pessoa_nome" class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                if($Read->getResult()) {
                                                    ...
                                                    foreach ($Read->getResult() as $Telefones) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="pt-3-half">
                                                                <input required type="tel" name="telefone_<?= $i ?>"
                                ...
                                <br/>
                                <input type="hidden" name="pessoa_tipo_id" value="8"/>
                                <input type="hidden" name="action" value="ProspeccaoEditar"/>
                        ...
                        <?php
                            ...
                            header('Location: painel.php?exe=crm/cadastro_prospeccao');
                            exit;
                        endif;
                    else:
                        $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".CRM_PROSPECCAO."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                        ...
                        <form class="form_prospeccao">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                     ...
                                     <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="bmd-label-floating"><?= $texto['DTNASC'] ?></label>
                                            <input type="text" name="pessoa_nascimento" class="form-control formDate">
                                        </div>
                                    </div>
                                     </div>
                                     <div class="row">
                            ...
                            <br/>
                            <input type="hidden" name="action" value="ProspeccaoAdd"/>
        ...
        ID FUNCIONALIDADE: <?= CRM_PROSPECCAO ?>
    </div>
  </div>