...
$Delete = new Delete;
$Delete->ExeDelete("sys_crm_tipo_atendimento", "WHERE tipo_atendimento_nome IS NULL OR tipo_atendimento_nome = :nm", "nm=''");
?>
          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllTPATD'] ?></h4>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=crm/cadastro_tipo_atendimento" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/Crm/ListTipoAtendimento.ajax.php?action=list"
