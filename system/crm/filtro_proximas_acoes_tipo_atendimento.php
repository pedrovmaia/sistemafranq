          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllNEXTACT'] ?></h4>
                      <p class="card-category"><?= $texto['RelNEXTACT'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=crm/cadastro_proximas_acoes_tipo_atendimento&idtipo=<?= $Id ?>" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/Crm/ListProximasAcoes.ajax.php?action=list&id=<?= $Id ?>"
