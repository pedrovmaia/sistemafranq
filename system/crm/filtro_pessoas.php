              ...
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title"><?= $texto['AllPEOPSS'] ?></h4>
                          <p class="card-category"><?= $texto['RelPEOPSS'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <div id="toolbar">
                    ...
                    if($permissao["inserir"] == 1) {
                        ?>
                        <a href="<?= BASE ?>/painel.php?exe=crm/cadastro_pessoas"
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/Crm/ListPessoas.ajax.php?action=list"
