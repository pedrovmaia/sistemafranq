...
if ($Id):
    ...
    if ($Read->getResult()):
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="livro_download_titulo" value="<?= $livro_download_titulo ?>" class="form-control">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="livro_download_descricao" value="<?= $livro_download_descricao ?>" class="form-control">
        ...
        header('Location: painel.php?exe=pedagogico/livro/cadastro_livro_download');
        exit;
    endif;
endif;
?>
