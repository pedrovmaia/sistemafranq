          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todos os quizzes</h4>
                      <p class="card-category">Relação de quizzes</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=pedagogico/quiz/cadastro_quiz" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/escola/ListQuiz.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" class="titulo" data-field="titulo" data-filter-control="input">Título</th>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="quantidade" data-filter-control="input">Quantiade de Perguntas</th>
