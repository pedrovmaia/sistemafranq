                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title">VER RESPOSTA</h4>
...
if ($Id):
    ...
    if ($Read->getResult()):
         ...
         <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="quiz_respostas_descricao" value="<?= $quiz_respostas_descricao ?>"   class="form-control">
                        </div>
                    </div>
                     <div class="col-md-6">
                        <div class="form-group">
                              <label class="bmd-label-floating">OPÇÃO</label>
                            <input type="text" disabled name="quiz_respostas_opcao" value="<?= $quiz_respostas_opcao ?>"  class="form-control">    
                        </div>   </div>
                    </div>
                    <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled name="quiz_respostas_seq" value="<?= $quiz_respostas_seq ?>"  class="form-control">   
        ...
        header('Location: painel.php?exe=pedagogico/quiz/cadastro_quiz_respostas');
        exit;
    endif;
endif;
?>
