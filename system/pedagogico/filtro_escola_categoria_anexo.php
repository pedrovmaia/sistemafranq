          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todas as categorias de anexos/downloads</h4>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=pedagogico/cadastro_escola_categoria_anexo" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/escola/ListCategoriaAnexo.ajax.php?action=list"
