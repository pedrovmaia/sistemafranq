          ...
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Todos os consultores</h4>
                          <p class="card-category">Todos os consultores de campo</p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/franqueador/ListConsultor.ajax.php?action=list"
