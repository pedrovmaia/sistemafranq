          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todos os treinamentos</h4>
                      <p class="card-category">Relação de treinamentos</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=pedagogico/cadastro_treinamentos" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/escola/ListTreinamentos.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" class="local" data-field="local" data-filter-control="input">Local</th>
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="categoria" data-filter-control="input">Categoria</th>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="datarealizacao" data-filter-control="input">Data de realização</th>
