...
<style>
        ...
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Todos os alunos</h4>
                          <p class="card-category">Todos os alunos cadastrados</p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <?php
                  $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".SEDE_ALUNOS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                  if($Read->getResult()){
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/sede/ListAlunosSede.ajax.php?action=list"
 ...
 <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="id" data-filter-control="input">ID</th>
                        ...
                        <th class="acoes headcol" data-field="acoes"><span> <?= $texto['Act'] ?></span>
                    </tr>
                    </thead>
                </table>
              </div>
