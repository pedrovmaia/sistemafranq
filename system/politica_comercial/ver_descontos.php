                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerDSCNTS'] ?></h4>
                                <p class="card-category"><?= $texto['VerDSCNTSi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
            ...
            <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                <label class="bmd-label-floating"><strong><?= $texto['informacoesBasicas'] ?></strong></label>
                    ...
                    <div class="form-group">
                                                ...
                                                <input disabled type="text" name="desconto_nome" value="<?= 
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                     ...
                                                     <select disabled style="margin-top: -3px" name="desconto_tipo_id" value="<?= $desconto_tipo_id ?>"  class="form-control jsys_instituicao_financeiras" data-style="btn btn-link" id="exampleFormControlSelect1">
                                     ...
                                     <div class="col-md-12">
                                       <div class="row">
                                        ...
                                        <div class="form-group">
                                         <label class="bmd-label-floating"><?= $texto['TPDVAL'] ?></label>
                                          <select disabled style="margin-top: -3px" name="desconto_tipo_valor" value="<?= $desconto_tipo_valor ?>"  class="form-control" data-style="btn btn-link" id="exampleFormControlSelect1">
                                      ...
                                      <div class="col-md-6">
                                        ...
                                        <label class="bmd-label-floating"><?= $texto['PriceM'] ?></label>
                                         <input disabled type="text" name="desconto_valor" value="<?=number_format($desconto_valor, 2, ',', '.') ?>" class="form-control">
                                               </div>
                                            </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                    ...
                                                    <input disabled type="text" name="desconto_data_inicial" value="<?= date('d/m/Y', strtotime($desconto_data_inicial)) ?>"  class="form-control formDate">
                                                </div>
                                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="bmd-label-floating"><?= $texto['FinalDateM'] ?></label>
                                                    <input disabled type="text" name="desconto_data_final" value="<?= date('d/m/Y', strtotime($desconto_data_final)) ?>"  class="form-control">
                                                </div>
                                            </div>
                    </div>
                </div>
                                     ...
                                     <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                         <label class="bmd-label-floating"><?= $texto['APLCV'] ?></label>
                                          <select disabled style="margin-top: -3px" name="desconto_aplicavel" value="<?= $desconto_aplicavel ?>"  class="form-control" data-style="btn btn-link" id="exampleFormControlSelect1">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="checkbox" disabled name="desconto_status" value="1" <?= ($desconto_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                        </div>
                    </div>
                </div>
                <br/>
