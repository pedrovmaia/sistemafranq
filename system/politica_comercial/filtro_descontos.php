          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllDSCNTS'] ?></h4>
                      <p class="card-category"><?= $texto['RelDSCNTS'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=politica_comercial/cadastro_descontos" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/politica_comercial/ListDescontos.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="tipovalor" data-filter-control="input"><?= $texto['TPDVALi'] ?></th>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="aplicavel" data-filter-control="input"><?= $texto['APLCVAi'] ?></th>
