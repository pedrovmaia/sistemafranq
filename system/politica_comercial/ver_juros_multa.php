                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $texto['VerMLTASJRS'] ?></h4>
                                <p class="card-category"><?= $texto['VerMLTASJRSi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
            ...
            <div id="informacoes_basicas" class="border_shadow" style="padding: 15px;">
                <label class="bmd-label-floating"><strong><?= $texto['informacoesBasicas'] ?></strong></label>
                    ...
                    <div class="form-group">
                                                ...
                                                <input type="text" disabled name="juros" value="<?= $juros ?>"  class="form-control">
                                            </div>
                                        </div>
                    ...
                    <div class="form-group">
                        <label class="bmd-label-floating"><?= $texto['MLTAS'] ?></label>
                                                    <input type="text" disabled name="multa" value="<?= $multa ?>" class="form-control">
                                               </div>
                                            </div>
                                                </div>
                                            </div>
                    ...
                    <div class="form-group">
                                                    ...
                                                    <input type="text" disabled name="data_inicial" value="<?= date('d/m/Y', strtotime($data_inicial)) ?>" class="form-control">
                                                </div>
                                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <label class="bmd-label-floating"><?= $texto['FinalDateM'] ?></label>
                                                    <input type="text" disabled name="data_final" value="<?= date('d/m/Y', strtotime($data_final)) ?>"  class="form-control">
                                                </div>
                                            </div>
