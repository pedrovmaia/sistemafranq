          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllMVR'] ?></h4>
                      <p class="card-category"><?= $texto['RelMVRi'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              ...
              if($permissao["ler"] == 1){
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                            ...
                            <?php if(isset($_SESSION['caixaSYS']))
                                    {?> 
                                  <a href="<?= BASE ?>/painel.php?exe=contasreceber/cadastro_movimentacao_recebimento" class="btn btn-primary pull-right"><?= $texto['NewREC'] ?></a>
                                  <?php
                                  }
                                  ?>
                  ...
                  <div id="botao" class="border_shadow" style="padding: 15px; margin-bottom: 5px">
                    <div class="row">
                    <div class="ml-3">
                        <?= $texto['InitialDatep'] ?><input type="date"  name="produto_nome" value="<?= date('Y-m-d',$data_incio) ?>" class="form-control data_inicio_busca">
                        <div class="clearfix"></div>
                    </div>
                      <div class="ml-3">
                         <?= $texto['FinalDatep'] ?><input type="date"  name="produto_nome"  value="<?= date('Y-m-d',$data_fim) ?>" class="form-control data_fim_busca">
                        <div class="clearfix"></div>
                    </div>
                        <div class="ml-3">
                            <span rel="financeiro/ListMovimentacaoRecebimento" class="btn btn-primary pull-right mt-4 j_sys_busca_data"><?= $texto['Searc'] ?></span>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                  </div>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/financeiro/ListMovimentacaoRecebimento.ajax.php?action=list&inicio=<?= date('Y-m-d',$data_incio) ?>&fim=<?= date('Y-m-d',$data_fim) ?>"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="fornecedor" data-filter-control="input"><?= $texto['CLNT'] ?></th>
