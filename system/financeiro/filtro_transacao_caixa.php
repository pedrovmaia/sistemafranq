          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllTDC'] ?></h4>
                      <p class="card-category"><?= $texto['RelTDCi'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              ...
              if($permissao["ler"] == 1){
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                           ...
                           <?php if(isset($_SESSION['caixaSYS']))
                                    {?> 
                              <a href="<?= BASE ?>/painel.php?exe=financeiro/cadastro_transacao_caixa" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                              <?php
                               }
                              ?>
                          <?php
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/financeiro/ListTransacaoCaixa.ajax.php?action=list"
