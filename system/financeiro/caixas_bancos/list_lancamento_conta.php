...
<div class="content">
  ...
  <div class="col-lg-12 col-md-12">
      <div class="card">
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">LANÇAMENTOS NAS CONTAS</h4>
                      <p class="card-category">LANÇAMENTO POR CONTAS</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              <?php
              $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FINANCEIRO_LIST_LANCAMENTO_CONTA."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
              if($Read->getResult()){
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                    <div class="ml-6">                    
                     <select style="margin-top: -3px" name="pessoa_nome" value="<?= $conta_bancaria ?>" class="form-control j_sys_lancamento_conta conta_busca"  rel="financeiro/ListLancamentoConta" data-style="btn btn-link" id="exampleFormControlSelect1  ">

                                                         <option value=""><?= $texto['SelCNTBANCX'] ?></option>
                                                        ...
                                                        if ($Read->getResult()):
                                                            foreach ($Read->getResult() as $Conta):
                                                                ?>
                                                                <option  value="<?= $Conta['conta_bancaria_id'] ?>"><?= $Conta['conta_bancaria_nome']  ?></option>
                                                            <?php
                                                            endforeach;
                                                        endif;
                                                        ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/financeiro/ListLancamentoConta.ajax.php?action=list&conta=<?= $conta_bancaria ?>"
                      ...
                      <tr>
                          ...
                          <th class="valor"  data-filter-control-placeholder="⌕" data-sortable="true" data-field="valor" data-filter-control="input">Valor</th>
                          <th  data-filter-control-placeholder="⌕" data-sortable="true" class="conta" data-field="conta" data-filter-control="input">Conta</th>
      ...
      ID FUNCIONALIDADE: <?= FINANCEIRO_LIST_LANCAMENTO_CONTA ?>
  </div>
