...
<div class="content">
  ...
  <div class="col-lg-12 col-md-12">
      <div class="card">
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todas as matrículas</h4>
          ...
          <div class="card-body">
              <?php
              $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FINANCEIRO_IMPRESSAO_CARNES."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
              if($Read->getResult()){
              ...
              if($permissao["ler"] == 1){
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/financeiro/ListMatriculas.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="data" data-filter-control="input">Emissão</th>
      ...
      ID FUNCIONALIDADE: <?= FINANCEIRO_IMPRESSAO_CARNES ?>
  </div>
