  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Todas parcelas recebidas</h4>
                          <p class="card-category">Relação de parcelas</p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <?php
                  $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".FINANCEIRO_LIST_PARCELAS_RECEBIDAS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                  if($Read->getResult()){
                ...
                <div id="botao" class="border_shadow" style="padding: 15px; margin-bottom: 5px">
                    ...
                    <div class="row">
                        ...
                        <div class="ml-3">
                            <span rel="financeiro/ListParcelasRecebidas" class="btn btn-primary pull-right mt-4 j_sys_busca_data">PESQUISAR</span>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                </div>
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/financeiro/ListParcelasRecebidas.ajax.php?action=list&inicio=<?= date('Y-m-d',$data_incio) ?>&fim=<?= date('Y-m-d',$data_fim) ?>"
                    ...
                    <tr>
                        ...
                        <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="datar" data-filter-control="input">Data de Recebimento</th>
                        <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="valor" data-filter-control="input"><?= $texto['Price'] ?></th>
                        <th data-filter-control-placeholder="⌕" data-sortable="true" data-field="valor_pago" data-filter-control="input">Valor pago</th>
        ...
        ID FUNCIONALIDADE: <?= FINANCEIRO_LIST_PARCELAS_RECEBIDAS ?>
    </div>