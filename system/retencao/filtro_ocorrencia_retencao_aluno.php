          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todas as ocorrências de retenção de aluno</h4>
                      <p class="card-category">Relação de ocorrências</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      ...
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=retencao/cadastro_ocorrencia_retencao_aluno" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/retencao/ListRetencaoAluno.ajax.php?action=list"
                      ...
                      <tr>
                          ...
                          <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="aluno" data-filter-control="input"><?= $texto['NomeMi'] ?></th>
