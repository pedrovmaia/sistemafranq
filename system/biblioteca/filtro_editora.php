          ...
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title"><?= $texto['AllEDITAS'] ?></h4>
                      <p class="card-category"><?= $texto['RelEDITAS'] ?></p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
              ...
              if($permissao["ler"] == 1){
                  ...
                  <div id="toolbar">
                      <br/>
                       ...
                       <a href="<?= BASE ?>/reports/Impressao.php?relatorio=RelatorioEditora" class="btn btn-primary pull-right"><?= $texto['RelPDF'] ?></a>
                      

                      <?php
                      if($permissao["inserir"] == 1) {
                          ?>
                          <a href="<?= BASE ?>/painel.php?exe=biblioteca/cadastro_editora" class="btn btn-primary pull-right"><?= $texto['AdcNv'] ?></a>
                          <?php
                      }
                      ?>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/franqueador/ListEditora.ajax.php?action=list"
