  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          ...
                          <p class="card-category"><?= $texto['AllCLNSCAD'] ?></p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <?php
                  $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".RELATORIOS_CLIENTES."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                  if($Read->getResult()){
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/relatorios/ListClientes.ajax.php?action=list"
                    ...
                    <tr>
                        ...
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="rg" data-filter-control="input">RG</th>
                        ...
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="unidade" data-filter-control="input"><?= $texto['UNITE'] ?></th>
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="data" data-filter-control="input"><?= $texto['DTAi'] ?></th>
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="escola" data-filter-control="input"><?= $texto['Schooli'] ?></th>
                        ...
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="sobre" data-filter-control="input"><?= $texto['ABOUT'] ?></th>
        ...
        ID FUNCIONALIDADE: <?= RELATORIOS_CLIENTES ?>
    </div>
