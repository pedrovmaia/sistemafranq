  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Todos os alunos trancados</h4>
                          <p class="card-category">Todos os alunos trancados</p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <?php
                  $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".RELATORIOS_ALUNOS_TRANCADOS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
                  if($Read->getResult()){
                ...
                <table  class="table table-hover display"
                        ...
                        data-url="_ajax/relatorios/ListAlunosTrancados.ajax.php?action=list"
                    ...
                    <tr>
                        ...
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" class="datardataturma" data-field="datardataturma" data-filter-control="input">Data Prevista de Reintegração</th>
                        <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="reintegracao" data-filter-control="input">Reintegração</th>  
                        ...
                        <th class="acoes headcol" data-field="acoes"><span style="";> <?= $texto['Act'] ?></span>                    </tr>
                    </thead>
                </table>
              </div>
            </div>
        ...
        ID FUNCIONALIDADE: <?= RELATORIOS_ALUNOS_TRANCADOS ?>
    </div>
