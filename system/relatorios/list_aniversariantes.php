...
<div class="content">
  ...
  <div class="col-lg-12 col-md-12">
      <div class="card">
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todos os aniversariantes</h4>
                      <p class="card-category">Relação de aniversáriantes</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              <?php
              $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".RELATORIOS_ANIVERSARIANTES."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
              if($Read->getResult()){
              ...
              if($permissao["ler"] == 1){
                  ?>       
                    ...
                    <div class="ml-3">
                      ...
                      <div class="ml-3">
                        ...
                        <div class="ml-3">
                            <span rel="relatorios/ListAniversariantes" class="btn btn-primary pull-right mt-4 j_sys_busca_data">PESQUISAR</span>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                  </div>
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/relatorios/ListAniversariantes.ajax.php?action=list&inicio=<?= date('Y-m-d',$data_incio) ?>&fim=<?= date('Y-m-d',$data_fim) ?>"
                          data-pagination="true"
                          data-id-field="id"
                          data-buttons-class="primary">
                      <thead>
                      <tr>
                          <th  data-filter-control-placeholder="⌕" data-sortable="true" class="pessoa" data-field="pessoa" data-filter-control="input"><?= $texto['NomeMi'] ?></th>
                          <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="data" data-filter-control="input"><?= $texto['DTAi'] ?></th>
                          <th  data-filter-control-placeholder="⌕" data-sortable="true" data-field="email" data-filter-control="input">E-Mail</th>
      ...
      ID FUNCIONALIDADE: <?= RELATORIOS_ANIVERSARIANTES ?>
  </div>
