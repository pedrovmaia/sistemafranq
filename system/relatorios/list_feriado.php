...
<div class="content">
  ...
  <div class="col-lg-12 col-md-12">
      <div class="card">
          <div class="card-header card-header-primary">
              <div class="row">
                  ...
                  <div class="col-md-10 text-center">
                      <h4 class="card-title">Todos os feriados</h4>
                      <p class="card-category">Relação de feriados</p>
                  </div>
                  <div class="col-md-1">
                  </div>
              </div>
          ...
          <div class="card-body">
              <?php
              $Read->ExeRead("sys_relacao_funcionalidade_nivel_acesso", "WHERE funcionalidade_id = :func AND nivel_acesso_id = :nivel", "func=".RELATORIOS_FERIADOS."&nivel={$_SESSION['userSYSFranquia']['pessoa_acesso_id']}");
              if($Read->getResult()){
              ...
              if($permissao["ler"] == 1){
                  ...
                  <table  class="table table-hover display"
                          ...
                          data-url="_ajax/relatorios/ListFeriado.ajax.php?action=list"
      ...
      ID FUNCIONALIDADE: <?= RELATORIOS_FERIADOS ?>
  </div>
