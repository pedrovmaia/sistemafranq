...
$Read->FullRead("SELECT * FROM sys_pessoas WHERE pessoa_tipo_id = 6 AND unidade_id = {$_SESSION['userSYSFranquia']['unidade_padrao']}");

$professores = $Read->getResult();
        
$total_professores = $Read->getRowCount();
          ...
          <div class="card">
              <div class="card-header card-header-primary">
                  <div class="row">
                      ...
                      <div class="col-md-10 text-center">
                          <h4 class="card-title">Relação de turmas por professor</h4>
                          <p class="card-category">Turmas por professor</p>
                      </div>
                      <div class="col-md-1">
                      </div>
                  </div>
            ...
            <div class="card-body">
                ...
                <div class="border_shadow" style="padding: 20px">
                    <div class="row">
                      <div class="col-md-12">
                        <p>Total de professores: <?php echo $total_professores;?>, Total de turmas: <?php echo $total_turmas;?></p>
                      </div>
                    </div>
                    <span rel="relatorios/ListTurmasProfessores" class="btn btn-primary pull-left mt-4 pdfTurmasProfessor">GERAR PDF</span>
                    ...
                    <table class="table table-hover display"
                        ...
                        data-url="_ajax/relatorios/ListTurmasProfessor.ajax.php?action=list"
