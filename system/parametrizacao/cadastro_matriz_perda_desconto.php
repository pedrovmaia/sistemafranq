                            ...
                            if ($Read->getResult()):
                                ...
                                <form class="form_matriz_perda_desconto">
                                    ...
                                    if($permissao["deletar"] == 1) {
                                        ?>
                                        <span rel='single_user_addr' callback='parametrizacao/MatrizPerdaDesconto' action="delete" class='j_delete_action_confirm icon-warning btn btn-danger' id='<?= $Id; ?>'><?= $texto['Del'] ?></span>
                                        <?php
                                    }
                                    ?>
