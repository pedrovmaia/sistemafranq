                    ...
                    <div class="card-header card-header-primary">
                        <div class="row">
                            ...
                            <div class="col-md-10 text-center">
                                <h4 class="card-title"><?= $Texto['VerHLMP'] ?></h4>
                                <p class="card-category"><?= $Texto['VerHLMPi'] ?></p>
                            </div>
                            <div class="col-md-1">
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input disabled type="text" name="feriado_municipal_nome" value="<?= $feriado_municipal_nome ?>" class="form-control">
                                                </div>
                                            </div>
<div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="bmd-label-floating"><?= $texto['DTA'] ?></label>
                                                    <input disabled type="text" name="feriado_municipal_data" value="<?= date('d/m/Y', strtotime($feriado_municipal_data)) ?>"  class="form-control">
                                                </div>
                                            </div>
                                        </div>
 <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    <input disabled type="checkbox" name="feriado_status" value="1" <?= ($feriado_status == 1 ? 'checked' : ''); ?>><?= $texto['InaC'] ?></label>
                                              </div>
                                            </div>
                                        </div>
                <br/>
